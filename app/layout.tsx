...
export const metadata: Metadata = {
  ...
  description:
    ...
    "芝浦工業大学デザイン工学部の学生・大学院生による卒業・修了研究展。プロダクト、システム、UX、感性、理論の探求など、デザイン工学の幅広い研究を、形ある展示から提案・概念まで多様なかたちで紹介し、学生一人ひとりの探求の軌跡を提示します。",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "芝浦工業大学デザイン工学部卒業展示2026 メインビジュアル",
      },
    ],
  },
